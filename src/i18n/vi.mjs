...
export default {
  ...
  portfolio: {
    ...
    builder: {
      ...
      lead: 'Chọn hai đến bốn hệ thống và xem hỗn hợp trọng số bằng nhau của lợi nhuận tháng đã vận hành thế nào trong cửa sổ chung của chúng. Giả định: trọng số bằng nhau, tái cân bằng hằng tháng, chỉ tính trên lợi nhuận tháng của backtest.',
      pick: 'Hệ thống',
      ...
      blend: 'Hỗn hợp trọng số bằng nhau',
      perSystem: 'Từng hệ thống trong cùng cửa sổ',
      assumptions: 'Chỉ tính từ lợi nhuận tháng backtest trong cửa sổ chung, trọng số bằng nhau và tái cân bằng hằng tháng. Sụt giảm đo trên giá trị đóng tháng nên thấp hơn mức giảm trong tháng. Là phép tính lịch sử, không phải dự báo.',
    },
    cta: {
