...
export default {
  ...
  portfolio: {
    ...
    builder: {
      ...
      lead: 'Pilih dua hingga empat sistem dan lihat bagaimana campuran bobot sama dari imbal hasil bulanannya berperilaku di jendela yang mereka miliki bersama. Asumsi: bobot sama, diseimbangkan ulang bulanan, dihitung hanya dari imbal hasil bulanan backtest.',
      pick: 'Sistem',
      ...
      blend: 'Campuran bobot sama',
      perSystem: 'Tiap sistem pada jendela yang sama',
      assumptions: 'Dihitung dari imbal hasil bulanan backtest pada jendela bersama saja, bobot sama dan diseimbangkan ulang bulanan. Drawdown diukur pada nilai penutupan bulanan sehingga meremehkan penurunan dalam-bulan. Aritmetika historis, bukan ramalan.',
    },
    cta: {
